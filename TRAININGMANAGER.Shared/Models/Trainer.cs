...
namespace TRAININGMANAGER.Shared.Models
{
    public class Trainer : IDbEntity<Trainer>
    {
        ...
        public Trainer(Guid id, string firstName, string lastName, DateTime birthsDay, string email, bool csapatEdzo, bool egyeniEdzo, bool asszisztens, string workingLevels, Guid ageGroupid, Guid workingTypeid)
        {
            Id = id;
            FirstName = firstName;
            LastName = lastName;
